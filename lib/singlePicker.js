                ...
                <View accessible={false} style={styles.basicContainer}>
                    <View accessible={false} style={[styles.modalContainer,this.props.style]}>
                        ...
                        <View accessible={false} style={[styles.buttonView, this.props.headerStyle]}>
                            {this.props.leftItem && <TouchableOpacity accessibilityRole='button' accessible={true} accessibilityLabel={this.lang.BTN_LEFT_BUTTON} onPress={this.changePrev} style={{ justifyContent: 'center', paddingHorizontal: 5, marginLeft: 15, marginRight: 15, height: 75, }}>
                              {this.props.leftItem}
                            </TouchableOpacity>}
                            {this.props.rightItem && <TouchableOpacity accessibilityRole='button' accessible={true} accessibilityLabel={this.lang.BTN_RIGHT_BUTTON} onPress={this.changeNext} style={{ justifyContent: 'center', paddingHorizontal: 5, height: 75 }} >
